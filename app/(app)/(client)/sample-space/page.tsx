          ...
          <div className="sample-space-col">
            <Copy delay={0.1}>
              <h3>
                ...
                frames daylight differently, shifting the mood as one moves from
                courtyard to living space.
              </h3>

              <h3>
                Materials were chosen for their quiet permanence: pale stone,
                lime plaster, and timber accents. These textures invite touch
                and age gracefully, ensuring the house evolves in character with
                time.
              </h3>
            </Copy>
          ...
          <div className="sample-space-col">
            ...
            <Copy delay={0.2}>
              <h3>
                ...
                experience. The aim was not only to frame views but to shape how
                sound, touch, and temperature are felt as one moves through the
                home.
              </h3>
            </Copy>
          </div>
