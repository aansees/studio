        ...
        <div className="space-y-14 pb-9">
          ...
          <div className="space-y-3">
            ...
            <RevealAnimation delay={0.2}>
              <p className="text-tagline-2 mx-auto w-full max-w-[320px] text-center text-white/60">
                No guesswork. We use AI + proven marketing systems to scale ads, SEO, and
                conversion.
              </p>
            </RevealAnimation>
          </div>
          <RevealAnimation delay={0.3}>
            <div className="flex justify-center">
              <PrimaryLinkButton href="/contact">Book a strategy call</PrimaryLinkButton>
            </div>
          </RevealAnimation>
        </div>
